...
- `.ibee-brain/_BRAIN-STATE.md` — tableau de bord projet
- `.ibee-brain/_decision-log-code.md` — décisions techniques
- `.ibee-brain/_decision-log-projet.md` — décisions non-code (business, méthode, stratégie)
- `.ibee-brain/pilier/` — vision non-négociable
- `.ibee-brain/technique/stack.md` — stack technique
